...
class ItemToPurchase:
  ...
  # Method to print out the item cost
  ...
  # Method to print item_description attribute for an itemToPurchase object
  def print_item_description(self):
    return f'{self.item_name}: {self.item_description}'

# Build the ShoppingCart class with specific data attributes and related methods.
...
class ShoppingCart:
  ...
  # Add method to return the total cost of items in the cart
...
def execute_menu(char, cart):
  if char == "a":
    ...
    new_obj = ItemToPurchase(item_name, item_quantity = new_quantity)
...
if __name__ == "__main__":
  ...
  print_menu()
  print()
  # while loop that prints the menu until user enters q
  while True:
